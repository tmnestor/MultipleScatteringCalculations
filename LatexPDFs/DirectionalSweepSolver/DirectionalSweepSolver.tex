...
\medskip\noindent
\textbf{Not yet done.} The in-out $k_y$ pair, and with it the full three-dimensional Cartesian
case, is the remaining piece; until it lands, the solver is 2\textonehalf-D and a comparison
against a three-dimensional solver measures the geometry rather than the sweeps.
