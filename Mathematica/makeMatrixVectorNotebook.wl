...
(* Generate MatrixVectorWaveEquation.nb from its verified executable twin
   MatrixVectorWaveEquation.wl, then verify faithfulness by re-importing and
   counting cells.  Same banner convention as makeCubeT9Notebook.wl: a line is
...
nb = Notebook[Prepend[cells,
   Cell["The elastodynamic matrix-vector wave equation  d3 q = A q + d",
