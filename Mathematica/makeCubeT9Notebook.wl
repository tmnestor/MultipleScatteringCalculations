...
(* Generate CubeT9FromFirstPrinciples.nb from its verified executable twin
   CubeT9FromFirstPrinciples.wl, then verify faithfulness by re-importing and
   counting cells.  Same banner convention as makeLatticeNotebook.wl: a line is
...
nb = Notebook[Prepend[cells,
   Cell["The cubic T-matrix from first principles \[LongDash] without Eshelby magic",
      "Title"]], WindowSize -> {1100, 800}];
Export[nbpath, nb];
