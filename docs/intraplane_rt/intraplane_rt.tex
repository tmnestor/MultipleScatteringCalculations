...
\item \textbf{Incident.} The incident wave is the $\epsilon$-normalised down-going eigenvector
  ...
  na\"ively conjugating the direction is wrong and was the post-critical bug). A transverse
  incident wave, $SV$ or $SH$, carries \emph{both} $\mathbf N$ and $\mathbf M$ multipoles whatever its
  polarisation; keeping only $\mathbf N$ for $SV$ and only $\mathbf M$ for $SH$ breaks energy balance
  and leaves a reciprocity residual of $10^{-10}$--$10^{-8}$.
...
\item \textbf{Project.} The specular scattered displacement at the up/down direction of mode $c$,
  $\mathbf U^{\mathrm{sc}}=\bigl(2\pi i/\eta_c\omega A_{\mathrm{cell}}\bigr)\,\mathbf f$ (the lattice Weyl
  prefactor times the multipole far-field $\mathbf f$, with $\mathbf u\sim\mathbf f\,e^{ikr}/r$: summed over
  the lattice, $e^{ikr}/r$ is $2\pi i/(A_{\mathrm{cell}}k_z)$ per order), is projected onto the $\epsilon$-normalised
...
\midrule
normal ($p=10^{-6}$)            & $4.7\times10^{-19}$ & $4.9\times10^{-18}$ & $1.2\times10^{-17}$\\
sub-critical ($p=0.5/\alpha$)   & $2.5\times10^{-16}$ & $2.6\times10^{-16}$ & $2.6\times10^{-18}$\\
post-critical ($p=0.8/\beta$)   & $3.2\times10^{-16}$ & $3.2\times10^{-16}$ & $2.3\times10^{-18}$\\
\bottomrule
\end{tabular}
\end{center}

All three are at round-off. The reflection residuals of $10^{-10}$--$10^{-8}$ previously
reported here were not a quadrature floor: they came from the incomplete incident expansion above. The plain-symmetric $\Tu=\Td^{T}$, $\Rd$ symmetric is the
